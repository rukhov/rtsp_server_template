...
int main(int argc, char *argv[])
{
  ...
  // gst_rtsp_media_factory_set_launch(factory, "( gst_color_bars_video_src ! video/x-raw,width=1920,height=1080,format=I420,framerate=30/1 ! x264enc ! rtph264pay name=pay0 pt=96 )");
